...
export default function QualitySection() {
  return (
    <section className="py-12 sm:py-24 lg:py-10 flex flex-col lg:flex-row items-center justify-center text-center lg:text-left space-y-8 lg:space-y-0 lg:space-x-24">
      ...
      <div className="lg:space-y-8">
        <p className="max-w-[600px] lg:max-w-none mb-8 lg:mb-0">
          U Beriku, ponosimo se izvanrednim rastom i zadovoljstvom kupaca. Naši
          statistički podaci prikazuju našu predanost pružanju visokokvalitetnih
          montažnih konstrukcija i garažnih vrata.
        </p>
